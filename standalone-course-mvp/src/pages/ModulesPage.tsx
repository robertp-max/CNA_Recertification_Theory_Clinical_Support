    ...
    <div className="flex flex-col lg:flex-row gap-8">
      <div className="w-full lg:w-80 shrink-0">
        <div className={`border rounded-xl p-6 lg:sticky lg:top-8 ${styles.sideCard}`}>
          ...
          <p className={`text-xs mb-6 leading-relaxed ${styles.body}`}>
            ContentV2 supplies the complete 720-minute required theory package across CCCCO Modules 10-17.
          </p>
      ...
      <div className="flex-1 space-y-6">
        <div>
          ...
          <p className={`text-xs ${styles.body}`}>ContentV2 data is loaded for Orientation plus CCCCO Modules 10 through 17.</p>
        </div>
