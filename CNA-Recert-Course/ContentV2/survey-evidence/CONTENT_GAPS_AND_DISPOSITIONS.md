...
## Source Repair (placeholder pending SME source)  (7)

| CCCCO obj | Objective | ContentV2 | Disposition note |
|---|---|---|---|
| M13.4 | Describe the special needs of persons with developmental and mental disorders in | M03/L05 | Special needs (developmental/mental disorders: ID, CP, epilepsy, Parkinson's, mental illness) map to M03/L05, currently a Source Repair placeholder. |
| M16.1 | Define key terminology | M03/L04 | Death/dying terminology maps to M03/L04, currently a Source Repair placeholder. |
| M16.2 | Describe the five stages of the grieving process according to Dr. Kubler-Ross | M03/L04 | Kubler-Ross five stages of grief: M03/L04 placeholder; author from CCCCO M16. |
| M16.3 | Describe approaches to meet common emotional and spiritual needs of terminally i | M03/L04 | Emotional/spiritual needs of the terminally ill and families: M03/L04 placeholder. |
| M16.5 | Differentiate between common signs of approaching death and biological death | M03/L04 | Signs of approaching death vs biological death: M03/L04 placeholder; author from CCCCO M16. |
| M16.6 | Identify care and comfort measures for dying patients/residents | M03/L04 | Care/comfort measures for dying patients/residents: M03/L04 placeholder. |
| M16.7 | Identify the philosophy and goals of hospice and the Nurse Assistant’s role when | M03/L04 | Hospice philosophy/goals and NA role: M03/L04 placeholder; author from CCCCO M16. |
...
| M15.4 | Define observation and list the senses used to observe a patient/resident. | M06/L01 | Definition of observation and the senses used. |
| M15.5 | Describe objective and subjective observations | M06/L01 | Objective vs subjective observation taught and exercised (core M06/L01). |
| M15.6 | List types of charting documents and the use for each | M06/L02 | Types of charting documents and their use. |
| M15.7 | Explain how to accurately complete ADL assessment for MDS | M06/L02 | ADL assessment for the MDS is facility/EHR-specific; theory explains purpose, completion is on-the-job. SME to confirm. |
| M15.8 | Discuss procedures to use when recording on a patient’s/resident’s chart | M06/L02 | Procedures for recording on the chart (incl. correction/PHI rules in M06). |
| M16.1 | Define key terminology | M03/L04 | Death/dying terminology maps to M03/L04, currently a Source Repair placeholder. |
| M16.2 | Describe the five stages of the grieving process according to Dr. Kubler-Ross | M03/L04 | Kubler-Ross five stages of grief: M03/L04 placeholder; author from CCCCO M16. |
| M16.3 | Describe approaches to meet common emotional and spiritual needs of terminally i | M03/L04 | Emotional/spiritual needs of the terminally ill and families: M03/L04 placeholder. |
| M16.4 | List the rights of the dying patient/resident | M03/L04; M02/L01 | Rights of the dying patient/resident overlap resident-rights (M02/L01, authored); dying-specific framing in M03/L04 placeholder. |
| M16.5 | Differentiate between common signs of approaching death and biological death | M03/L04 | Signs of approaching death vs biological death: M03/L04 placeholder; author from CCCCO M16. |
| M16.6 | Identify care and comfort measures for dying patients/residents | M03/L04 | Care/comfort measures for dying patients/residents: M03/L04 placeholder. |
| M16.7 | Identify the philosophy and goals of hospice and the Nurse Assistant’s role when | M03/L04 | Hospice philosophy/goals and NA role: M03/L04 placeholder; author from CCCCO M16. |
| M16.8 | Describe procedures and responsibilities for postmortem care | M03/L04 | Postmortem care is a hands-on clinical procedure; M03/L04 theory placeholder pending SME. |
| M17.1 | Define key terminology | M02/L01; M02/L02 | Abuse terminology in M02/L01-L02. |
| M17.2 | Identify and discuss types of elder abuse | M02/L02 | Types of elder abuse taught and exercised (core M02/L02). |
| M17.3 | Discuss the issues related to elder abuse | M02/L03 | Issues related to elder abuse (signs/symptoms/evidence in M02/L03). |
| M17.4 | Explain the Nurse Assistant role in preventing elder abuse | M02/L05 | NA role in preventing abuse (boundaries/safety, M02/L05) taught and assessed. |
| M17.5 | Describe the Nurse Assistant role in reporting elder abuse | M02/L04 | NA role in reporting abuse / mandated-reporter duties (M02/L04) taught and assessed. |
