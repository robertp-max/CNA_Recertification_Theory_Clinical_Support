# Validation Report — NATP Module 16: Death and Dying

| Check | Result |
|---|---|
| Source authority is the approved Module 16 PDF | PASS |
| Objective count parsed from source | PASS (8) |
| Weighted minutes total equals selected theory minutes | PASS (120) |
