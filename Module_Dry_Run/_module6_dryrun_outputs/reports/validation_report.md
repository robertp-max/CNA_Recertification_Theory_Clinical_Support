# Validation Report — NATP Module 6: Medical and Surgical Asepsis

| Check | Result |
|---|---|
| Source authority is the approved Module 6 PDF | PASS |
| Objective count parsed from source | PASS (13) |
