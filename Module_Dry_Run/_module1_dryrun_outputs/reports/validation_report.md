# Validation Report — NATP Module 1: Introduction to Nurse Assistant

| Check | Result |
|---|---|
| Source authority is the approved Module 1 PDF | PASS |
| Objective count parsed from source | PASS (8) |
| Weighted minutes total equals selected theory minutes | PASS (300) |
