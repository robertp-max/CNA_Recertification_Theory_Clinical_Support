# Validation Report — NATP Module 17: Patient/Resident Abuse

| Check | Result |
|---|---|
| Source authority is the approved Module 17 PDF | PASS |
| Objective count parsed from source | PASS (5) |
| Weighted minutes total equals selected theory minutes | PASS (420) |
