# CDSS Source Research Index - LIC 9141 Vendor Application

    Updated source baseline: June 3, 2026. Official CDSS sources control over internal drafts.
...
| Vendor Automation Platform | https://ca-dss.prod.simpligov.com |
    ...
    ## Items Marked [PENDING CDSS CONFIRMATION]

    - Final Vendor Automation Platform workflow requires current account access and ACB/assigned analyst confirmation.
    - Any CDSS interpretation not explicit in the cited public sources remains [PENDING CDSS CONFIRMATION].
