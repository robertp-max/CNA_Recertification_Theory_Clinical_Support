...
Review lens ID: 02_objectives_source_map
Review lens: Official objective coverage and source-map audit: objective counts, objective titles, page/source references, source assets, terminology, answer-key internal-only handling.
...
1. `# Review 02_objectives_source_map — Module 13`
