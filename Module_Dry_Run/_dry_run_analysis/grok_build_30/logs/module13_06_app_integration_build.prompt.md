...
Review lens ID: 06_app_integration_build
Review lens: App integration/build audit: generated data copied to app, active contentV2 pointer, LessonPlayer reuse, build/typecheck evidence, and current-tree validation caveats.
...
1. `# Review 06_app_integration_build — Module 13`
