You are one of 10 independent Grok Build reviewers for Module 13.

Review lens ID: 03_time_allotment
Review lens: Weighted theory time audit: exact minute total, per-objective distribution, clinical/assessment/certificate exclusion, and whether source-recommended versus minimum hours are handled correctly.
...
- For Modules 11/13, apply checkpoint principles but use the module's own declared values from the bundle: objectives=8, weighted minutes=780.
...
1. `# Review 03_time_allotment — Module 13`
