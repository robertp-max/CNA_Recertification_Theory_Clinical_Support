...
Review lens ID: 07_media_audio_qwen
Review lens: Media/audio/Qwen/SFX/image audit: Qwen requirement, narration manifest/package format, CSV vs JSON, generated WAV status, image alt text/prompt-only status, SFX license gates.
...
1. `# Review 07_media_audio_qwen — Module 13`
