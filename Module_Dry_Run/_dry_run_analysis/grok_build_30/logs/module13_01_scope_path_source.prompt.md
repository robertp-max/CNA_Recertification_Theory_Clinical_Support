...
Review lens ID: 01_scope_path_source
Review lens: Scope/path/source-authority audit: active write scope, app root, output root, source PDF, stale ContentV2/backups, path contradictions, and whether reports over-claim.
...
1. `# Review 01_scope_path_source — Module 13`
