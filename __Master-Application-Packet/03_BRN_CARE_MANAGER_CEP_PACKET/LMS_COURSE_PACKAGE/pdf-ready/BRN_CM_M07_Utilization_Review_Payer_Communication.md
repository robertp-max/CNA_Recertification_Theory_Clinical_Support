...
## Utilization Review, Medical Necessity, and Payer-Safe Communication
...
8 items, unlimited attempts, immediate feedback, no full key, >=80% to complete.
...
- CM-M07 knowledge check passed at >=80% (require passing grade).
