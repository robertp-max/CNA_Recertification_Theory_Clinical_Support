...
def footer(page_number: int, page_total: int = 46, left: str = "TJ Padilla / RCFE CDSS Application Binder") -> str:
    return f"""
      <footer class="page-footer">
        <div class="footer-left">{escape(left)}</div>
...
def page(page_number: int, title: str, body: str, *, compact: bool = False) -> str:
    ...
    <div id="p{page_number}" class="page{compact_class}">
      ...
      {footer(page_number, left="TJ Padilla / RCFE CDSS Application Binder")}
    </div>
    """
    ...
    return [
        ...
        page(
            ...
            {table(["Authorization", "Detail"], [
                ...
                ["Packet Coordination", "Final packet routing, verification tracking, and submission coordination."],
            ], [34, 66])}
